...
const servicesList = [
  {
    num: "01",
    title: "Website\nDevelopment",
    desc: "Custom, high-converting website development — fast, SEO-ready, mobile-first builds on fixed timelines.",
    features: ["Next.js / React", "SEO-Ready", "Mobile-First"],
  ...
  },
  {
    num: "03",
    title: "SEO, AEO\n& GEO",
    desc: "Rank on Google and get cited by ChatGPT, Perplexity & AI Overviews — one strategy for three search surfaces.",
    features: ["Answer Engine Opt.", "AI Search Visibility", "Schema Markup"],
  ...
  },
  {
    num: "04",
    title: "Google &\nMeta Ads",
    desc: "Performance-driven Google and Meta ad campaigns, tracked to the rupee, optimized for conversion.",
  ...
  },
  {
    num: "05",
    title: "Social Media\nManagement",
    desc: "End-to-end social media presence across Instagram, LinkedIn, and Facebook — content, posting, and community.",
    features: ["Content Calendar", "Community Mgmt", "Monthly Reports"],
  ...
  },
  {
    num: "06",
    title: "AI Content &\nVideo Production",
    desc: "Studio-grade product photos, marketing videos, and ad creatives generated with advanced AI models.",
    features: ["AI Photography", "Ad-Ready Videos", "A/B Variants"],
    link: "/services/ai-content-video-production",
    color: "#A06A00",
  },
  {
    num: "07",
    title: "Analytics &\nTracking",
    desc: "GA4, Meta Pixel & Conversions API setup, funnel audits, and dashboards — accurate tracking from day one.",
    features: ["GA4 Events", "Conversions API", "Looker Studio"],
