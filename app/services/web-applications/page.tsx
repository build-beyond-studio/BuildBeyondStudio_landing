    ...
    <main className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="max-w-4xl mx-auto py-24 px-4 sm:px-6">
        ...
        <div className="space-y-12 text-gray-300">
          <div>
            <h2 className="text-2xl font-semibold text-white mb-4">Our Tech Stack</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-white mb-4">Our Development Process</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-white mb-4">Based in Ambikapur, Serving India</h2>
            <p className="leading-relaxed">
        ...
        <div className="mt-16 p-8 rounded-xl bg-blue-600/10 border border-blue-600/20">
          <h2 className="text-2xl font-semibold text-white mb-3">Ready to build your web application?</h2>
          <p className="text-gray-400 mb-6">Tell us what you need. We'll give you a clear estimate and timeline within 24 hours.</p>
