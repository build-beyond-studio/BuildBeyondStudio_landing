...
export default function PortfolioSection({ 
  ...
  const websites = [
    ...
    },
    {
      ...
      videoSrc: "/our_work_videos/dozzed.mp4",
      link: "https://www.getdozzed.com/"
    },
    {
      title: "OffMenu",
      subtitle: "Skin Hydration drink",
      videoSrc: "/our_work_videos/offmenu.mp4",
