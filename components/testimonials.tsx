...
export default function Testimonials() {
  ...
  return (
    <section className="bg-[#F5F2EC] py-12 md:py-16 px-4 sm:px-6 border-t border-black/5">
          ...
          <div className="flex items-center justify-center w-full h-full relative">
            ...
            <div className="relative w-full h-full flex items-center justify-center px-4">
              ...
              <div className="relative w-full md:w-3/4 h-full flex items-center justify-center transition-all duration-700 ease-out">
                <div className="w-full h-4/5 rounded-xl overflow-hidden shadow-lg bg-gray-50 backdrop-blur-md border border-black/5">
                  <img
                    key={currentIndex}
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`transition-all duration-300 rounded-full ${index === currentIndex
                  ? 'bg-black w-8 h-2'
                  : 'bg-black/10 w-2 h-2 hover:bg-black/20'
                  }`}
